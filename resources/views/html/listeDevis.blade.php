        ...
        <div class="col-lg-12 d-flex align-items-stretch">
          <div class="card w-100">
            <div class="card-body p-6">
              <h5 class="card-title fw-semibold mb-4">Liste Devis</h5>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">{{ number_format($devis->prixTotal,4, ',', ' ') }} Ar</p>
                            </td>
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">{{ number_format($devis->payer,4, ',', ' ') }} Ar</p>
                            </td>
                            <td class="border-bottom-0">
                              <p class="mb-0 fw-normal">{{ number_format($devis->resteAPayer,4, ',', ' ') }} Ar</p>
                      
                            </td>
                            <td class="border-bottom-0 align-middle">
                                <p class="badge bg-danger rounded-pill me-2">{{ $devis->etatPaiement }}</p>
                            </td>
                            <td class="border-bottom-0">
                              <a href="" class="btn btn-primary btn-sm">Détails</a>
                            </td>
                            <td class="border-bottom-0">
                              <a href="" class="fw-semibold mb-0 sort-link">Export Pdf</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
